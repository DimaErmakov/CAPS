...
# NOTE: the data are generated using a function that best matches the
# "baby bear" model family below.
g = lambda x : 3*x + 2
...
# NOTE: generally, we would do this once for one data set rather than
# in a loop. this mimics using many different datasets.
